package com.example.loadingbox.indicatorview;
...
import com.example.loadingbox.R;
import com.example.loadingbox.indicatorview.indicators.BallPulseIndicator;
...
public class AVLoadingIndicatorView extends View {
    ...
    private static final int MIN_SHOW_TIME = 10; // ms
    private static final int MIN_DELAY = 10; // ms
    ...
    private void init(Context context,AttributeSet attrs,int defStyleAttr, int defStyleRes) {
        ...
        mIndicatorColor=a.getColor(R.styleable.AVLoadingIndicatorView_indicatorColor, Color.parseColor("#eb1010"));
