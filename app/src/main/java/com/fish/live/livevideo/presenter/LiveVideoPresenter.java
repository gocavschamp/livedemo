package com.fish.live.livevideo.presenter;
 ...
 */
public class LiveVideoPresenter extends BasePAV<LiveVideoCotract.View> implements LiveVideoCotract.Presenter {
...
//                });
    ...
    public LiveVideoPresenter(LiveVideoCotract.View view) {
        mView = view;
    }
}
