 ...
 * 近期直播搜索
 */
public class RecommentLiveSearchActivity extends BaseActivity implements OnTabSelectListener, TextWatcher, BaseQuickAdapter.RequestLoadMoreListener {
    ...
    protected void initData() {
        ...
        data.add("心里洁疾病");
        data.add("推荐打发");
        tabLayout.setTabData(data.toArray(new String[data.size()]));
